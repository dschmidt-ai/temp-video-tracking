...
class Exp(MyExp):
    def __init__(self, n_workers=8, debug=False, reid=False):
        ...
        # TODO: Find out correct relative path
        self.max_id_dict_f_path = "/Users/dschmidt/PycharmProjects/MCMOT-ByteTrack/datasets/max_id_dict.npz"
